...
class ModelOptimization:
    ...
    def DeepLearningTrochTraining(self, XStamps, YStamps, HiddenSize, BatchSzie, DropoutRate, Epoch):
        ...
        DTWDistance= round(dtw.distance(self.SingleVariateTrainX, MutipleStepsRollingPredictionResults), 4)* 10000
...
if __name__ == "__main__":
    ...
    Sp= 0.860; EOL= 0.800
    # OptParam: OptXStamp:   4// OptYStamp:   1// OptHiddenSize:  94// OptBatchSzie:  37// OptDropoutRate: 0.000000// OptEpoch: 930
    OptXTimeStamps= 10; OptYtimeStamps= 6; OptBatchSize= 10; Epoch= 10000; LearningRate= 0.00000000001; EarlyStopEpoch= 1
    plt.figure(figsize= (10, 4))
    ...
    if ModelOptimizationProcess== True:
        ...
        ParamBounds= [(8, 12), (1, 7), (6, 128), (8, 128), (0.001, 0.1), (10, 1000)]
        ...
        for Tindex in range(0, len(Battery2DischargeCapacity)):
            ...
            if TargetSOH <= Sp and RulActivation== True:
                ...
                RulActivation= False
        plt.figure(figsize= (10, 4))
        plt.plot(Battery2Cycle[: Tsp], SOHls[: Tsp], label= "Actual Battery#2 (known)", color= "black")
        plt.plot(Battery2Cycle[Tsp: ], SOHls[Tsp: ], label= "Actual Battery#2 (unknown)", color= "darkblue")
